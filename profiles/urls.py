...
from profiles.views import AllowedProfileList, AllowedUserDetail, ApproveExpert, CustomUserViewset, CurrentProfileViewset, SetDefaultProfile, MandateViewset, OpenProfileList, OpenProfileDetail
