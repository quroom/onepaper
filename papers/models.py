...
class VerifyingExplanation(models.Model):
    ...
    ledger_building_category = models.CharField(max_length=13)
    actual_building_category = models.CharField(max_length=13)
    ...
    noise_status = models.PositiveSmallIntegerField()
    vibration = models.PositiveSmallIntegerField()
