...
class VerifyingExplanation(models.Model):
    ...
    explanation_evidence_info = models.CharField(max_length=100, blank=True)
    requesting_condition_info = models.CharField(max_length=100, blank=True)
    address = models.OneToOneField(Address,
                                   null=True,
                                   on_delete=models.SET_NULL)
    ...
    matters_of_violation = models.CharField(max_length=100, blank=True)
    land_ownership = models.CharField(max_length=200, blank=True)
    building_ownership = models.CharField(max_length=200, blank=True)
    land_other = models.CharField(max_length=200, blank=True)
    building_other = models.CharField(max_length=200, blank=True)
    rental_housing_registration = models.PositiveSmallIntegerField(choices=RENTAL_HOUSING_REGISTRATION_CATEGORY)
    use_area = models.CharField(max_length=40, blank=True)
    use_district = models.CharField(max_length=40, blank=True)
    use_zone = models.CharField(max_length=40, blank=True)
    ...
    planning_facilities = models.CharField(max_length=40, blank=True)
    ...
    unit_planning_area_others = models.CharField(max_length=40, blank=True)
    other_use_restriction = models.CharField(max_length=40, blank=True)
    ...
    subway_station = models.CharField(max_length=40, blank=True)
    subway_by_foot = models.NullBooleanField(null=True, blank=True)
    ...
    parking_lot_info = models.CharField(max_length=20, blank=True)
    ...
    undesirable_facilities_info = models.CharField(max_length=100,blank=True)
    ...
    water_damage_status_info = models.CharField(max_length=40, blank=True)
    water_capacity_status = models.BooleanField()
    water_capacity_status_info = models.CharField(max_length=40, blank=True)
    electricity_supply_status = models.BooleanField()
    electricity_supply_status_info = models.CharField(max_length=40, blank=True)
    gas_supply_status = models.BooleanField()
    gas_supply_status_info = models.CharField(max_length=40, blank=True)
    ...
    heating_status_info = models.CharField(max_length=40, blank=True)
    heating_type = models.PositiveSmallIntegerField(choices=HEATING_TYPE_CATEGORY)
    heating_type_info = models.CharField(max_length=40, blank=True)
    ...
    drainage_status_info = models.CharField(max_length=40, blank=True)
    other_facilities = models.CharField(max_length=100, blank=True)
    wall_crack_status = models.BooleanField()
    wall_crack_status_info = models.CharField(max_length=40, blank=True)
    water_leak_status = models.BooleanField()
    water_leak_status_info = models.CharField(max_length=40, blank=True)
    wall_paper_status = models.NullBooleanField()
    wall_paper_status_info = models.CharField(max_length=40, blank=True)
