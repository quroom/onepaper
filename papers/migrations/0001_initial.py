    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.PositiveSmallIntegerField(choices=[(1, '임대인(매도인)'), (2, '임차인(매수인)'), (3, '공인중개사')])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(1, '티비'), (2, '냉장고'), (3, '세탁기'), (4, '에어컨'), (5, '침대'), (6, '책상'), (7, '옷장'), (8, '신발장'), (9, '가스렌지'), (10, '전자렌지'), (11, '도어락'), (12, '비데'), (99, '추가물품')], max_length=29, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, '요청중'), (2, '작성중'), (3, '서명중'), (4, '완료')], default=2)),
            ],
        ),
        migrations.CreateModel(
            name='Signature',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paper_categories', multiselectfield.db.fields.MultiSelectField(choices=[(1, '단독주택'), (2, '공동주택'), (3, '매매'), (4, '임대')], max_length=7)),
                ('explanation_evidences', multiselectfield.db.fields.MultiSelectField(choices=[(1, '등기권리증'), (2, '등기사항증명서'), (3, '토지대장'), (4, '건축물대장'), (5, '지적도'), (6, '임야도'), (7, '토지이용계획확인서'), (99, '기타')], max_length=16)),
                ...
                ('ledger_building_category', models.PositiveSmallIntegerField(blank=True, choices=[(70, '제1종근린생활시설'), (71, '제2종근린생활시설'), (80, '단독주택'), (81, '아파트'), (99, '기타')], default=80)),
                ('actual_building_category', models.PositiveSmallIntegerField(blank=True, choices=[(70, '제1종근린생활시설'), (71, '제2종근린생활시설'), (80, '단독주택'), (81, '아파트'), (99, '기타')], default=80)),
                ...
                ('rental_housing_registration', models.PositiveSmallIntegerField(choices=[(0, '해당사항없음'), (1, '장기일반민간임대주택'), (2, '공공지원민간임대주택'), (99, '그 밖의 유형')])),
                ('rental_housing_registration_info', models.CharField(blank=True, max_length=35)),
                ('mandatory_lease_period', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('lease_initiation_date', models.DateField(blank=True, null=True)),
                ('right_to_lease_contract_renewal', models.BooleanField(blank=True, default=None, null=True)),
                ...
                ('speculative_area', models.PositiveIntegerField(blank=True, choices=[(1, '토기투기지역'), (2, '주택투기지역'), (3, '투기과열지구')], null=True)),
                ...
                ('parking_lot', models.PositiveSmallIntegerField(choices=[(0, '없음'), (1, '전용주차시설'), (2, '공동주차시설'), (99, '그 밖의 주차시설')])),
                ...
                ('management', models.PositiveSmallIntegerField(choices=[(1, '위탁관리'), (2, '자체관리'), (99, '그 밖의 유형')])),
                ...
                ('heating_supply_method', models.PositiveSmallIntegerField(choices=[(1, '중앙공급'), (2, '개별공급')])),
                ('heating_status', models.BooleanField()),
                ('heating_status_info', models.CharField(blank=True, max_length=10)),
                ('heating_type', models.PositiveSmallIntegerField(choices=[(1, '도시가스'), (2, '기름'), (3, '프로판가스'), (4, '연탄'), (99, '그밖의종류')])),
