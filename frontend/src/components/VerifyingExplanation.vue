    ...
    >
      ...
      <tr>
        ...
        <td class="border-tbl" width="495" colspan="15">
          <div>
            ［
            {{ ve.rental_housing_registration == 1 ? "√" : "" }}
            ］장기일반민간임대주택 ［
            {{ ve.rental_housing_registration == 2 ? "√" : "" }}
            ］공공지원민간임대주택 ［
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ({{ ve.elementary_school }}) 학교, 소요시간: (［{{
              ve.elementary_school_by_foot ? "√" : ""
            }}］도보 ［{{ ve.elementary_school_by_foot ? "" : "√" }}］차량) 약
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ({{ ve.middle_school }}) 학교, 소요시간: (［{{
              ve.middle_school_by_foot ? "√" : ""
            }}］도보 ［{{ ve.middle_school_by_foot ? "" : "√" }}］차량) 약
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ({{ ve.department_store }}), 소요시간: (［{{
              ve.department_store_by_foot ? "√" : ""
            }}］도보 ［{{ ve.department_store_by_foot ? "" : "√" }}］차량) 약
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ({{ ve.medical_center }}), 소요시간: (［{{
              ve.medical_center_by_foot ? "√" : ""
            }}］도보 ［{{ ve.medical_center_by_foot ? "" : "√" }}］차량) 약
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ［{{ ve.electricity_supply_status ? "√" : "" }}］정상 ［{{
              ve.electricity_supply_status ? "" : "√"
            }}］교체 필요 (교체할 부분: {{ ve.electricity_supply_status_info }})
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td class="border-tbl" width="419" colspan="12">
          <div>
            ［{{ ve.heating_type == 1 ? "√" : "" }}］도시가스 ［{{
              ve.heating_type == 2 ? "√" : ""
            }}］기름 ［{{ ve.heating_type == 3 ? "√" : "" }}］프로판가스 ［{{
              ve.heating_type == 4 ? "√" : ""
            }}］연탄 ［{{ ve.heating_type == 99 ? "√" : "" }}］그 밖의 종류 ({{
          ...
          <td class="border-tbl" width="478" colspan="8">
            <div>
              ［{{ ve.wall_paper_status == 2 ? "√" : "" }}］깨끗함 ［{{
                ve.wall_paper_status == 1 ? "√" : ""
              }}］보통임 ［{{ ve.wall_paper_status == 0 ? "√" : "" }}］도배 필요
            </div>
          </td>
        </tr>
        <tr>
